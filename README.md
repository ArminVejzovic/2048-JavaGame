...
GUI Interface:
    ...
    Arrow keys (Up, Down, Left, Right) are used to move tiles in the selected direction.
    ...
    The goal is to reach the 2048 tile, but players can continue playing after reaching 2048 to achieve higher scores.
